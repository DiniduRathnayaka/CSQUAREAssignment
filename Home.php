        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">Csquare Technologies Private Limited</h1>
                    ...
                    <div class="d-flex align-items-center pt-5">
                        <a href="index.php" class="btn btn-primary py-3 px-4 me-5">Customer</a>
                    </div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="item.php" class="btn btn-primary py-3 px-4 me-5">Item</a>
                    </div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="invoiceread.php" class="btn btn-primary py-3 px-4 me-5">Invoice Report</a>
                    </div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="invoiceitemread.php" class="btn btn-primary py-3 px-4 me-5">Invoice Item Report</a>
                    </div>

                    <div class="d-flex align-items-center pt-5">
                        <a href="readitems.php" class="btn btn-primary py-3 px-4 me-5"> Item Report</a>
                    </div>
