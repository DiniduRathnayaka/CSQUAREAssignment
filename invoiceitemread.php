<?php include "php/invoiceitemread.php";  ?>
...
<body>
  ...
  <h5><b>
      <center>Invoice Item Report Table</center>
    </b>
  </h5>
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td><a href="viewDetailsinvoiceitem.php?id=<?= $rows['id'] ?>" class="btn btn-primary">View Details</a></td>
